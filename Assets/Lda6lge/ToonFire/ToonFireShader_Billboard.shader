...
Shader "Lda6lge/ToonFire/Billboard"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma surface surf Unlit keepalpha noshadow nolightmap  nodynlightmap nodirlightmap vertex:vertexDataFunc 
		struct Input
		{
			float2 uv_texcoord;
		};
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( 0 + ( ase_vertex3Pos * ase_objectScale ) );
		}
...
/*ASEBEGIN
Version=17000
66;246;1310;728;1823.321;470.8865;2.095428;True;False
...
Node;AmplifyShaderEditor.ObjectScaleNode;60;-974.1837,576.2311;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.PosVertexDataNode;61;-971.5612,418.0334;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;-734.3551,494.5993;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BillboardNode;62;-833.0208,339.6078;Float;False;Cylindrical;True;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;64;-564.2225,478.5005;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=493CB130129A1D2DE7C9D95107E9B21DDCB34F71